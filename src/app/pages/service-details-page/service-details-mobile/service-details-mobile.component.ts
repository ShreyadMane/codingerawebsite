...
@Component({
  selector: 'app-service-details-mobile',
  standalone: true,
  imports: [RouterLink,PageBannerComponent, NgFor,TestimonialsComponent],
  templateUrl: './service-details-mobile.component.html',
  styleUrl: './service-details-mobile.component.scss'
})
export class ServiceDetailsMobileComponent {
  featureBox = [
    {
