...
@Component({
  selector: 'app-service-details-software',
  standalone: true,
  imports: [RouterLink,PageBannerComponent, NgFor,TestimonialsComponent],
  templateUrl: './service-details-software.component.html',
  styleUrl: './service-details-software.component.scss'
})
export class ServiceDetailsSoftwareComponent {
  featureBox = [
    {
