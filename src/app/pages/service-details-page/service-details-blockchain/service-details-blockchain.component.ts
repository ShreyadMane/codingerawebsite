...
@Component({
  selector: 'app-service-details-blockchain',
  standalone: true,
  imports: [RouterLink,PageBannerComponent, NgFor,TestimonialsComponent],
  templateUrl: './service-details-blockchain.component.html',
  styleUrl: './service-details-blockchain.component.scss'
})
export class ServiceDetailsBlockchainComponent {
