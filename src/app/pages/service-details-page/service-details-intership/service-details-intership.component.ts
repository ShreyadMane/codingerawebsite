...
@Component({
  selector: 'app-service-details-intership',
  standalone: true,
  imports: [RouterLink,PageBannerComponent, NgFor,TestimonialsComponent],
  templateUrl: './service-details-intership.component.html',
  styleUrl: './service-details-intership.component.scss'
})
export class ServiceDetailsIntershipComponent {
