...
@Component({
  selector: 'app-service-details-aidevelopment',
  standalone: true,
  imports: [RouterLink,PageBannerComponent, NgFor,TestimonialsComponent],
  templateUrl: './service-details-aidevelopment.component.html',
  styleUrl: './service-details-aidevelopment.component.scss'
})
export class ServiceDetailsAidevelopmentComponent {
  featureBox = [
    {
